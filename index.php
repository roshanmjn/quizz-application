		...
		<?php if(isset($_SESSION['msg'])){ ?>
 		...
 		<!--FORM STARTS -->
			<form action="" method="post" class="form-inside">
				<div class="username">
					<input class="form-input" type="text" name="username" placeholder="Username or Email" value="<?php if(!empty($_POST['username'])){echo $_POST['username'];} ?>" autocomplete="off" autofocus>
				</div>
