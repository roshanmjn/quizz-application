...
<div class="faculty-container container">
	<div class="faculty-wrapper wrapper">
		...
		<div class="faculty-main">
			<table id="faculty-table">
				...
				<tr>
					...
					<td>
						<a href="update_faculty.php" class="btn btn-success">
							<input type="hidden" value="<?php echo $_SESSION['faculty_update_id'] = $faculty['faculty_id']; ?>" >UPDATE
						</a>
					</td>
					<td>
						<a href="delete_faculty.php" class="btn btn-danger">
